...
var TimeGrid = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'div',
      { className: 'rbc-time-view ' + this.props.className },
  ...
  _adjustGutter: function _adjustGutter() {
    ...
    this._gutterWidth = _domHelpersQueryWidth2['default'](_reactDom.findDOMNode(this.refs.gutter));

    if (width !== this._gutterWidth) {
      width = this._gutterWidth + 'px';
      this._gutters.forEach(function (node) {
